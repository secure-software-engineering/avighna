...
public class HybridCallGraph {
     ...
     */
    public void merge(String dtsFileName, CallGraph staticCallGraph, String outputDotFileName, String outputImageName, ImageType imageType) throws UnexpectedError, DtsSerializeUtilException, DtsZipUtilException, DotToImgException {
        merge(dtsFileName, staticCallGraph, outputDotFileName);

        switch (imageType) {
            case SVG:
                saveDotAsImageFile(outputDotFileName + ".dot", outputImageName + ".svg", Format.SVG);
                break;
            case PNG:
                saveDotAsImageFile(outputDotFileName + ".dot", outputImageName + ".png", Format.PNG);
                break;
        }
    }
     ...
     * @throws DotToImgException         Failed to convert DOT to image file
     */
    public void merge(String dtsFileName, CallGraph staticCallGraph, String outputDotFileName, String outputImageName) throws UnexpectedError, DtsSerializeUtilException, DtsZipUtilException, DotToImgException {
     ...
     * @throws DtsZipUtilException       Zip utility failed to unzip DTS fie
     */
    public void merge(String dtsFileName, CallGraph staticCallGraph, String outputDotFileName) throws UnexpectedError, DtsSerializeUtilException, DtsZipUtilException {
