...
public class HybridCallGraph {
     ...
     *
     * @param dynamicEdgesInAGraphs List of dynamically generated EdgesInAGraph
     * @param staticCallGraph       Static call graph generated by the soot
     */
    public void merge(List<EdgesInAGraph> dynamicEdgesInAGraphs, CallGraph staticCallGraph) {
     ...
     */
    public void merge(List<EdgesInAGraph> dynamicEdgesInAGraphs, CallGraph staticCallGraph, String outputDotFileName, String outputImageName, ImageType imageType) {
        merge(dynamicEdgesInAGraphs, staticCallGraph, outputDotFileName);
     ...
     * @param outputImageName       Image file name of the dot file of the new call graph
     */
    public void merge(List<EdgesInAGraph> dynamicEdgesInAGraphs, CallGraph staticCallGraph, String outputDotFileName, String outputImageName) {
        merge(dynamicEdgesInAGraphs, staticCallGraph, outputDotFileName, outputImageName, ImageType.SVG);
    }
     ...
     * @param outputDotFileName     File name of the generated dot file of the new call graph
     */
    public void merge(List<EdgesInAGraph> dynamicEdgesInAGraphs, CallGraph staticCallGraph, String outputDotFileName) {
        dotGraph = new DotGraph("final:callgraph");
        // Generate the initial dot-graph from the static call-graph
        generateDotGraph();

        merge(dynamicEdgesInAGraphs, staticCallGraph);
    ...
    public static void main(String[] args) {
        ...
        new HybridCallGraph().merge(edgesInAGraphs, Scene.v().getCallGraph(), "callgraph", "callgraph", ImageType.PNG);
    }
