...
import de.fraunhofer.iem.avighna.util.DirectedEdge;
import de.fraunhofer.iem.avighna.util.EdgesInAGraph;
import de.fraunhofer.iem.avighna.util.SerializableDotGraph;
import de.fraunhofer.iem.avighna.util.SerializableUtility;
        ...
        if (this.continuousCallStack.size() == 0) {
            ...
            for (int index = 0; index < stackTraceElements.length; ++index) {
                ...
                if (temp.startsWith(currentMethodSignature + "(")) {
                    ...
                    if (!nextMethodSignature.startsWith("de.fraunhofer.iem.avighna.DynamicCallStackManager")) {
